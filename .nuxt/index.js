...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"棉花糖智慧校园管理平台","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width,initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no,viewport-fit=cover"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"script":[],"style":[]},
  ...
  if (typeof nuxt_plugin_vuePageTrasition_373de3e8 === 'function') {
    await nuxt_plugin_vuePageTrasition_373de3e8(app.context, inject)
  }
