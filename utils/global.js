...
const filterFpType = [
  { text: "电子发票(增值税普通发票)", value: "电子发票(增值税普通发票)" ,label: '电子发票(增值税普通发票)', name: '电子发票(增值税普通发票)'},
  { text: '电子发票(增值税专用发票)', value: '电子发票(增值税专用发票)' ,label: '电子发票(增值税专用发票)' ,name: '电子发票(增值税专用发票)'},
  { text: '增值税普通发票', value: '增值税普通发票' ,label: '增值税普通发票' ,name: '增值税普通发票'},
  { text: '增值税专用发票', value: '增值税专用发票' ,label: '增值税专用发票' ,name: '增值税专用发票'},
  { text: '货运运输业增值税专用发票', value: '货运运输业增值税专用发票' ,label: '货运运输业增值税专用发票' ,name: '货运运输业增值税专用发票'},
  { text: '机动车销售统一发票', value: '机动车销售统一发票' ,label: '机动车销售统一发票' ,name: '机动车销售统一发票'},
  { text: '增值税普通发票(卷式)', value: '增值税普通发票(卷式)' ,label: '增值税普通发票(卷式)' ,name: '增值税普通发票(卷式)'},
  { text: '二手车销售统一发票', value: '二手车销售统一发票' ,label: '二手车销售统一发票' ,name: '二手车销售统一发票'},
  { text: '区块链电子发票', value: '区块链电子发票' ,label: '区块链电子发票' ,name: '区块链电子发票'},
  { text: '财政电子票据', value: '财政电子票据' ,label: '财政电子票据' ,name: '财政电子票据'},
  { text: '定额发票', value: '定额发票' ,label: '定额发票' ,name: '定额发票'},
  { text: '通用机打发票', value: '通用机打发票' ,label: '通用机打发票' ,name: '通用机打发票'},
  { text: '通用电子发票', value: '通用电子发票' ,label: '通用电子发票' ,name: '通用电子发票'},
  { text: '医院门诊收费票据 (电子)', value: '医院门诊收费票据 (电子)' ,label: '医院门诊收费票据 (电子)' ,name: '医院门诊收费票据 (电子)'},
  { text: '剪开式', value: '剪开式' ,label: '剪开式' ,name: '剪开式'},
  { text: '全电发票 (普通发票)', value: '全电发票 (普通发票)' ,label: '全电发票 (普通发票)' ,name: '全电发票 (普通发票)'},
  { text: '全电发票(纸质专用发票)', value: '全电发票(纸质专用发票)' ,label: '全电发票(纸质专用发票)' ,name: '全电发票(纸质专用发票)'},
  { text: '通用电子发票', value: '通用电子发票' ,label: '通用电子发票' ,name: '通用电子发票'},
  { text: '全电发票(增值税专用发票)', value: '全电发票(增值税专用发票)' ,label: '全电发票(增值税专用发票)' ,name: '全电发票(增值税专用发票)'},
  { text: '增值税普通发票(通行费)', value: '增值税普通发票(通行费)' ,label: '增值税普通发票(通行费)' ,name: '增值税普通发票(通行费)'},
  { text: '增值税电子专用发票', value: '增值税电子专用发票' ,label: '增值税电子专用发票' ,name: '增值税电子专用发票'},
  { text: '火车票', value: '火车票' ,label: '火车票' ,name: '火车票'},
  { text: '飞机票', value: '飞机票' ,label: '飞机票' ,name: '飞机票'},
  { text: '客车票', value: '客车票' ,label: '客车票' ,name: '客车票'},
  { text: '其他发票', value: '其他发票' ,label: '其他发票' ,name: '其他发票'}
];
